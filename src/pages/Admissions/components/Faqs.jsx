function Faqs() {
  return (
    <div className="mx-20 my-40">
      <h2 className="text-header mt-10">FAQs</h2>
        ...
        <div className="flex flex-row gap-10">
          ...
          <p className="w-2/3 sm:text-1xl md:text-2xl lg:text-3xl font-thin">
            ...
            <ul className="list-disc ml-10 mt-7">
              ...
              <li>
                Present and Previous Level Report Card (for Grade 1 to 11
                applicants)
              </li>
              <li>
                Parent Questionnaire (for Pre-Kinder and Kinder applicants)
              </li>
              <li>Recommendation Forms (for Grade 1 to 11 applicants)</li>
              <li>Junior High School ESC Certificate*</li>
              <li>Senior High School Voucher*</li>
              <li>Baptismal Certificate*</li>
              <li>First Communion Certificate*</li>
              <li>Parent’s Marriage Certificate*</li>
              <li>Alien Certificate of Registration**</li>
              <li>Photocopy of Passport or Visa**</li>
            </ul>
            <p className="mt-7">*Only if applicable.</p>
            <p>**Additional requirements for foreign applicants.</p>
            <p>***Additional requirements for non-Catholic applicants.</p>
            <p className="mt-10">
              Enrollment Period: The enrollment period typically begins in May.
            </p>
          </p>
        </div>
      </div>
      <div className="w-1/2 h-5 border-b border-faqs border-dashed"></div>
        ...
        <div className="flex flex-row gap-10">
          ...
          <p className="w-2/3 sm:text-1xl md:text-2xl lg:text-3xl font-thin">
            <div>
              ...
              the Cashier/Accounting Office.
            </div>
            <div className="mt-5">
              The school does not offer scholarships or financial aid but
              accepts ESC and SHS Vouchers from PEAC programs. For further
              information, please reach out to the Registrar.
            </div>
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-20  pb-20 pt-20">
        ...
        <div className="flex flex-row gap-10">
          ...
          <p className="w-2/3 sm:text-1xl md:text-2xl lg:text-3xl font-thin">
            ...
            government announcements and informs parents via SMS and official
            platforms.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-20  pb-20 pt-20">
        ...
        <div className="flex flex-row gap-10">
          ...
          <p className="w-2/3 sm:text-1xl md:text-2xl lg:text-3xl font-thin">
            ...
            charged in full unless due to a justifiable reason determined by the
